...
Behavioral guidelines to reduce common LLM coding mistakes. Built on [Andrej Karpathy's observations](https://github.com/multica-ai/andrej-karpathy-skills) on LLM coding pitfalls, extended with [Anthropic's Claude Code best practices](https://docs.anthropic.com/en/docs/claude-code).
